...
%% je nach 30 oder 20 bar auskommentieren
% figure ('Name','Volumenstrom-Sginal-Kennlinie');
% 
% plot(Volumenstrom_Signal_30bar,"Ue",["QLh30","QLd30"]);
% hold on;
% grid on;
% plot(Ue,QL30);
% hold on;
% 
% plot(Volumenstrom_Signal_20bar,"Ue",["QLh20","QLd20"])
% hold on;
% plot(Ue,QL20);
% disp(QL30);
% disp(QL20);
...
Ue2 = [-0.5;-0.4;-0.3;-0.2;-0.15;-0.1;-0.08;-0.06;-0.04;-0.02;0;0.02;0.04;0.04;0.06;0.08;0.1;0.15;0.2;0.3;0.4;0.5]';
